class ApplySupermarketRefrigeration < OpenStudio::Measure::ModelMeasure
  ...
  def run(model, runner, user_arguments)
    ...
    # Build condensers — skip setRatedEffectiveTotalHeatRejectionRate (not in OS 3.11)
    condenser_map = {}
    ...
    objects.select { |o| o['type'] == 'OS:Refrigeration:WalkIn' }.each do |obj|
      ...
      wi.setDefrostType('Electric') if obj['DefrostType'] && obj['DefrostType'].downcase.include?('electric')
